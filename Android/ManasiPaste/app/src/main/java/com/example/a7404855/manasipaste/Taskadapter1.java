...
class Taskadapter1 extends RecyclerView.Adapter<Taskadapter1.TaskHolder> {

private final Cursor cursor;

    public Taskadapter1(SQLiteDatabase database) {
        cursor = database.rawQuery( "select * from task", new String[]{});
    }
